...
class CustomUserDetailsService(
    ...
    override fun loadUserByUsername(username: String?): UserDetails =
        memberRepository.findByLoginId(username) ?.let { createUserDetails(it) } ?: throw UsernameNotFoundException("해당 유저는 없습니다.")   // findByLoginId로 조회되면 let - createUserDetails 구문을 탐
